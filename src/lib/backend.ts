...
// In a Tauri WebView this is present; in a plain browser (LAN --serve or `bun dev`) it is absent.
// Using runtime detection keeps the same embedded dist/ working for both exe and --serve
